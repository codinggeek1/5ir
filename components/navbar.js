  ...
  return (
    <div className={styles.navbar}>
      ...
      <div className={styles.btn_container}>
        {!currentAccount ?
          <button className={`${styles.btn} ${styles.connectBtn}`} onClick={connectWallet}>Connect Wallet</button>
          :
          <button className={`${styles.btn} ${styles.connectedBtn}`}>Wallet Connected</button>
        }
      </div>
      <div className={`${styles.toggleIcon} ${toggleIcon}`} onClick={toggle}>
        <div></div>
        <div></div>
        <div></div>
      </div>
